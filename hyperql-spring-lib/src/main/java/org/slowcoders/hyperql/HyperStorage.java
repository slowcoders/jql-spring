...
public abstract class HyperStorage {
    ...
    public HyperStorage(TransactionTemplate transactionTemplate,
    ...
    public abstract <ID> HyperRepository<ID> loadRepository(String tableName);

    public abstract <T, ID> EntitySet<T, ID> loadEntitySet(String tableName);
