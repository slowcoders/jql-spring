...
public class HyperSelect {
    ...
    public static HyperSelect of(Map<String, Object> selectSpec) {
        if (selectSpec == null || selectSpec.isEmpty()) return Auto;

        HyperSelect select = HyperSelect.of("*");
