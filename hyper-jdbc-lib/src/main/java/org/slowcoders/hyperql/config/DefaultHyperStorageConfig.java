package org.slowcoders.hyperql.config;

import com.fasterxml.jackson.databind.Module;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ObjectNode;
import lombok.SneakyThrows;
import org.slowcoders.hyperql.jpa.HyperJpaModule;
...
public class DefaultHyperStorageConfig {
    ...
    @Bean
    public Module hqlJacksonModule() {
        HyperJpaModule hm = new HyperJpaModule();
        return hm;
    }
