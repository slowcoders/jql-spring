...
INSERT INTO starwars.author (species, id, name, height, mass, metadata) values
...
INSERT INTO starwars.book (id, name, length, author_id) values
...
INSERT INTO starwars.author_episode_link (author_id, episode_id) values
(1000, 'NEWHOPE'),
(1000, 'EMPIRE'),
(1000, 'JEDI'),
(1001, 'NEWHOPE'),
...
INSERT INTO starwars.author_friend_link (author_id, friend_id)
values
(1000, 1002),
(1000, 1003),
(1000, 2000),
