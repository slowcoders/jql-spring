 ...
 */
@Entity
@Table(schema = "petclinic", name = "types")
public class PetType extends NamedEntity {
    @org.springframework.stereotype.Repository
    public static class Repository extends JPARepositoryBase<PetType, Integer> {

        public Repository(JqlService service) {
            super(service, PetType.class);
        }

        @Override
        public Integer getEntityId(PetType petType) {
