...
public abstract class JqlStorageController {
    ...
    public KVEntity get(@PathVariable("table") String table,
        ...
        JqlRepository<JqlEntity, Object> repository = getRepository(table);
        Object id = repository.convertId(id$);
        JqlEntity entity = repository.find(id);
        if (entity == null) {
    ...
    protected JqlRepository<JqlEntity, Object> getRepository(String tableName) {
