...
public abstract class JdbcController<ID> extends JQLController.SearchAndUpdate<KVEntity, ID> {
    JQLRepository<KVEntity, ID> repository;

    public JdbcController(JQLJdbcService service, String tablePath) {
