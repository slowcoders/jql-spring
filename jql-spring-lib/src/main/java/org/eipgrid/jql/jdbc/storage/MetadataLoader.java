...
public abstract class MetadataLoader {
    ...
    protected final JdbcSchemaLoader storage;

    protected final String defaultNamespace;

    protected final boolean schemaSupported;

    public MetadataLoader(JdbcSchemaLoader storage, String defaultNamespace, boolean schemaSupported) {
...
//        return sb.toString();
    ...
    static class JoinData {
        ...
        JoinData(ResultSet rs, MetadataLoader loader) throws SQLException {
